...
export enum UpdateGroupActionType {
    LOADING = '[groups] UPDATE LOADING',
    SUCCESS = '[groups] UPDATE SUCCESS',
...
export enum UpdateBoxActionType {
    LOADING = '[boxes] UPDATE LOADING',
    SUCCESS = '[boxes] UPDATE SUCCESS',
...
export enum CreateProviderActionType {
    LOADING = '[providers] CREATE LOADING',
    SUCCESS = '[providers] CREATE SUCCESS',
