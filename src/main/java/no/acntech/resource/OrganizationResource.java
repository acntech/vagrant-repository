...
public class OrganizationResource {
    ...
    public ResponseEntity<Organization> getOrganization(@PathVariable(name = "name") String name) {
    ...
    public ResponseEntity<Organization> updateOrganization(@PathVariable(name = "name") String name,
    ...
    public ResponseEntity<Void> deleteOrganization(@PathVariable(name = "name") String name) {
        organizationService.deleteOrganization(name);
        return ResponseEntity.noContent().build();
    }

    @PostMapping(path = "{name}/user")
    public ResponseEntity<Organization> addOrganizationMember(@PathVariable(name = "name") String name,
    ...
    public ResponseEntity<Organization> removeOrganizationMember(@PathVariable(name = "name") String name,
