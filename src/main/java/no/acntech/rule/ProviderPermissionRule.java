...
@Component
public class ProviderPermissionRule extends MembershipAwarePermissionRule {


    protected ProviderPermissionRule(final SecurityService securityService,
    ...
    public boolean isRelevant(@NonNull final Action action,
        ...
        return resource == Resource.PROVIDERS;
    }
