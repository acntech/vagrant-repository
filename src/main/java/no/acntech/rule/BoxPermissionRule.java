...
@Component
public class BoxPermissionRule extends MembershipAwarePermissionRule {


    protected BoxPermissionRule(final SecurityService securityService,
    ...
    public boolean isRelevant(@NonNull final Action action,
        ...
        return resource == Resource.BOXES;
    }
