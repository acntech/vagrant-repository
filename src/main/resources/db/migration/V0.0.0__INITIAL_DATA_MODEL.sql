...
(
    ...
    CONSTRAINT MEMBERS_ORGANIZATION_ID_USER_ID_UC UNIQUE (ORGANIZATION_ID, USER_ID),
    CONSTRAINT MEMBERS_ORGANIZATION_ID_FK FOREIGN KEY (ORGANIZATION_ID) REFERENCES ORGANIZATIONS (ID) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT BOXES_ORGANIZATION_ID_FK FOREIGN KEY (ORGANIZATION_ID) REFERENCES ORGANIZATIONS (ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT VERSIONS_BOX_ID_FK FOREIGN KEY (BOX_ID) REFERENCES BOXES (ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT PROVIDERS_VERSION_ID_FK FOREIGN KEY (VERSION_ID) REFERENCES VERSIONS (ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT UPLOADS_PROVIDER_ID_FK FOREIGN KEY (PROVIDER_ID) REFERENCES PROVIDERS (ID) ON DELETE CASCADE
);
